...
export default function AccountCrossDeposit({ accountId }) {
  const [{ tableData }, setState] = useRedux("accountCrossDeposit", { tableData: {} });

  const tableService = useMemo(() => new TableService(api.fetchBtcDeposits$, tableData, { accountId: accountId }), []);
